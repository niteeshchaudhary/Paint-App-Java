...
public class FillColor extends JPanel implements ActionListener , ChangeListener,MouseMotionListener , MouseListener,Runnable , Printable
{
	public FillColor()
	{	
...
// ***************//if (mPaintToolBar.getTool() == PaintToolBar.FILLCOLOR) setCursor(fillCursor);
	...
	{
		if(e.getX() <=NeewW.width && e.getY() <=NeewW.height && e.getX() >0 && e.getY() >0)
		{
